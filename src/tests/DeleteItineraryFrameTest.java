...
/**
 * The DeleteItineraryFrameTest class contains unit tests for the DeleteItineraryFrame functionality.
 */
class DeleteItineraryFrameTest {
    ...
    void test() {
        ...
        // Creates a new ArrayList containing the Itineraries that are expected to remain.
